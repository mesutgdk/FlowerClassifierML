...
- 🌴if the pod file is not inclueded and not downloaded, 
...
- Write "pod install" into terminal and press enter,
...
- ☘️After that unzipp the FlowerClassification.zip file u downloaded from the link above, implement 'FlowerClassifier.mlmodel' file by dragging it to the menu section of your xcode application.
